package com.anshu.foodmood.adapter
...
import com.anshu.foodmood.R
import com.anshu.foodmood.activity.Dashboard
import com.anshu.foodmood.activity.RestaurantMenuActivity
import com.anshu.foodmood.database.RestaurantDatabase
import com.anshu.foodmood.database.RestaurantEntity
import com.anshu.foodmood.model.RestaurantMenu
import com.anshu.foodmood.model.Restaurant
...
class DashboardFragmentAdapter(val context:Context,var itemList:ArrayList<Restaurant>):RecyclerView.Adapter<DashboardFragmentAdapter.ViewHolderDashboard>() {
    ...
    override fun onBindViewHolder(holder: ViewHolderDashboard, position: Int) {
        ...
        holder.textViewPricePerPerson.text = "Rs. "+restaurant.cost_for_one + "/Person "
