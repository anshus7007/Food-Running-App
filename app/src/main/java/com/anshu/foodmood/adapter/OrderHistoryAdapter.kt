...
import com.anshu.foodmood.activity.*
import com.anshu.foodmood.model.CartItems
import com.anshu.foodmood.model.OrderHistoryRestaurant
    ...
    override fun onBindViewHolder(holder: ViewHolderOrderHistoryRestaurant, position: Int) {
        ...
        if (ConnectionManager().checkConnectivity(context)) {
            ...
            try {
                ...
                val url =
                    "http://" + context.getString(R.string.ip_address) + "/v2/orders/fetch_result?userId=" + user_id
